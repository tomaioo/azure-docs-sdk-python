---
title: 
keywords: Azure, python, SDK, API, azure-mgmt-sphere, sphere
ms.date: 05/12/2026
ms.topic: reference
ms.devlang: python
ms.service: sphere
...
- [Search Sphere Management](/samples/browse/?languages=python&term=Getting%20started%20-%20Managing&terms=Getting%20started%20-%20Managing) on docs.microsoft.com

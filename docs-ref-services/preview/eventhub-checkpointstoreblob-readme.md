...
keywords: Azure, python, SDK, API, azure-eventhub-checkpointstoreblob, azure-event-hubs
ms.date: 05/14/2026
ms.topic: reference
ms.devlang: python
ms.service: azure-event-hubs
---
# Azure EventHubs Checkpoint Store using Storage Blobs client library for Python - version 1.2.1a20260514001 
